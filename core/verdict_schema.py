# -*- coding: utf-8 -*-
"""Proposal §2 / §4 Stage 3 — verdict JSON schema validation & normalization.
...
def normalize_verdict(
    ...
    *,
    ...
    """Coerce pipeline/LLM output into the proposal verdict object."""
    if raw is None:
        raw = {}
    ...
    # Never invent numeric p_hat. Missing predictor → null + hedged label.
