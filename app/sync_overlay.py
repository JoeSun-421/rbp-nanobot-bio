...
def sync_overlay(*, quiet: bool = False) -> int:
    ...
    if not nanobot_src_ok:
        # NANOBOT_SRC unusable (e.g. upstream restructured to a subdir). Skip the
        # NANOBOT_SRC-side tool/skill copy and only mirror into the imported
        # nanobot — that is what pytest/CLI import. Workspace skill still synced.
