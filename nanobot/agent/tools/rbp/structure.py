...
class PredictStructureTool(Tool):
    ...
    def description(self) -> str:
        return (
            ...
            "catalogue sequence. Do not invent poly-A. Prefer structure_fetch / "
            "struct_similarity when AFDB PDB already exists. Call ≤1 time; "
            "failures are disk-cached."
        )
