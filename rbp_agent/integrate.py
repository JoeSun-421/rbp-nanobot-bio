...
_PKG_DIR = Path(__file__).resolve().parent  # .../nanobot-bio/rbp_agent
...
from rbp_agent.core.paths import DEFAULT_AGENT_TRACE, ensure_artifact_dirs
from rbp_agent.core.verdict_schema import extract_verdict_from_content, validate_verdict
...
def _register_tools(registry) -> list[str]:
    """Register curated P0–P2 tools + Stage whitelist extras (not full delivery surface)."""
    try:
    ...
    from rbp_agent.backends.delivery.registry import register_tools
